...
#line 127 "calc++-parser.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::vector<NewTreeNode*>* v, const location_type& l);
    ...
    static inline
    symbol_type
    make_LBREACK (const location_type& l);

    static inline
    symbol_type
    make_RBREACK (const location_type& l);

    static inline
    symbol_type
    make_ENDLN (const location_type& l);
    ...
    static inline
    symbol_type
    make_QUOT (const location_type& l);
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_LBREACK (const location_type& l)
  {
    return symbol_type (token::TOK_LBREACK, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_RBREACK (const location_type& l)
  {
    return symbol_type (token::TOK_RBREACK, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_ENDLN (const location_type& l)
  {
    return symbol_type (token::TOK_ENDLN, l);
  }
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_PACKAGE (const location_type& l)
  {
    return symbol_type (token::TOK_PACKAGE, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_IMPORT (const location_type& l)
  {
    return symbol_type (token::TOK_IMPORT, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_FUNC (const location_type& l)
  {
    return symbol_type (token::TOK_FUNC, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_VAR (const location_type& l)
  {
    return symbol_type (token::TOK_VAR, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_QUOT (const location_type& l)
  {
    return symbol_type (token::TOK_QUOT, l);
  }
...
#line 1230 "calc++-parser.hh" // lalr1.cc:377
